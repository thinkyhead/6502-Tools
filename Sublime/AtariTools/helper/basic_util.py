...
s_TRAP, s_GOTO, s_GOSUB, s_COLOR = [s_GR] * 4

# Statements with no parameters
# <DOS> = <EOS> <END>
# ABML: JS(EOS) RTN
s_RAD = (s_EOS kRTN)
s_CSAVE, s_CLOAD, s_DOS, s_CLR, s_RET, s_END, s_STOP, s_POP, s_NEW, s_BYE, s_CONT, s_DEG = [s_RAD] * 12
...
s_PLOT, s_POS, s_DRAWTO = [s_POKE] * 3
...
s_NSMAT = ( f_TNVAR, cLPRN, kCHNG, cDLPRN, s_EXP, s_NMAT2, cRPRN,
    kOR,    f_TSVAR, cLPRN, kCHNG, cDSLPR, s_EXP, cRPRN,
    kRTN
)
