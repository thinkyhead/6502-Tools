...
def h_LIST(args=None) -> None:
    ...
    list_program(start=start, end=end, abbrev=args_abbrev)

def h_CLIST(args=None) -> None:
    print()
    start, end = two_int_args(args)
    list_program(start=start, end=end, abbrev=args_abbrev, colorify=True)
