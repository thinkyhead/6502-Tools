...
def emit_arg_rest_of_line(start, end):
    ...
    print(statement_table[start:end].decode('ascii', errors='replace'), end='')
    pass
...
def emit_token_at_index(i):
    ...
    if atok == 0x0F:
        ...
        # TODO: Replace decoded bytes with our UTF-8 using atascii.py
        print('"' + atascii_to_unicode_str(str_bytes, aflag=True) + '"', end='')
        return strlen + 2
