...
XPRND:		LDXY	RNDDIV			; POINT TO 65535
...
ATAN1:		LDXY	FPSCR			; ARCTAN[X], -1<X<1 BY SERIES OF APPROXIMATIONS
		JSR	FSTOR			;X->FSCR
		JSR	FMOVE			; X->FR1
		JSR	FMUL			; X*X->FR0
		BCS	ATNOUT			; 0'FLOW
		...
		BEQ	ATAN2			; NO
		LDXY	PIOV4			; YES-ADD ARCTAN[1.0] = PI/4
		JSR	FLD1R
		JSR	FADD
...
ATAN2:		LDA	DEGFLG			; RADIANS OR DEGREES
		BEQ	ATNOUT			; RAD - FINI
		LDXY	PIOV18			; DEG - DIVIDE BY PI/180
		JSR	FLD1R
		JSR	FDIV
ATNOUT:		RTS
...
@SQRLP:		LDXY	FSCR1
		...
		BPL	@SQRLP
@SQRDON:	LDXY	FSCR1			; DELTA = 0 - GET Y BACK
		JSR	FLD0R
;	WAS ARG TRANSFORMED
		LDA	XFMFLG
		BEQ	@SQROUT			; NO FINI
