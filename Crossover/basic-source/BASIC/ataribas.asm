...
RISASN:		LDA	VTYPE+EVSADR
		...
		STA	ADFLAG			; IN ASSIGN/DIM FLAG
		JSR	_EXOPOP			; AND PROCESS SUBSTRING
...
XGOTO:		JSR	GETPINT			; GET POSTIVE INTEGER IN FR0
;
...
;
		LDA	#0			; GET SNALLEST POSSIBLE LINE NUM
		STA	TSLNUM			; X
		STA	TSLNUM+1		; X
...
@CL:		STA	SREG3-1,X
		...
		STY	IODVC
@CLALL:		JSR	CLSYSD			; CLOSE DEVICE
		DEC	IODVC			; DEV DEVICE #
		BNE	@CLALL			; BR IF NOT ZERO
		RTS
