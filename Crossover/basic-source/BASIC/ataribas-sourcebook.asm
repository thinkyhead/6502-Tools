...
XPPOWER:	JSR	ARGP2		;GET ARGUMENT IN FR0,FR1
		...
		BEQ	@P0		;IF = 0 ; BRANCH
		BPL	TGOOD		;IF >0, ANSWER = 0
		BMI	TBAD		;IF <0, VALUE ERROR
@P0:		JMP	XTRUE		;IF =0, ANSWER = 1

@N0:		BPL	@SPEVEN		; IF BASE + THEN NO SPECIAL PROCESS
...
TCHK:		bcs	TBAD
		...
		bne	TGOOD
		sta	FR0
		beq	TGOOD		; A=0 so will always branch
